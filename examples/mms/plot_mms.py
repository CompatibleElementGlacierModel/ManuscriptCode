...
for i,n in enumerate(N):
    ...
    #axs[0].loglog(dts,eps_U_final,'o--',base=2,c=cmap(c))

"""
results_dir_cn = '../../results/mms_cn/'
H_inf, H_2, U_2 = pickle.load(open(f'{results_dir_cn}/norms_time_dependent.p','rb'))
...
axs[0].loglog(dts,eps_H_final,'o:',base=10,c=cmap(c),alpha=1.0)
#axs[0].loglog(dts,eps_U_final,'o--',base=2,c=cmap(c))
"""
